...
import { ShoppingBag, Bike, ShieldCheck, Wallet, Compass, HeartHandshake } from 'lucide-react';
...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-[10005] bg-white/95 backdrop-blur-md border-t border-gray-100 pt-2 shadow-lg"
      style={{
