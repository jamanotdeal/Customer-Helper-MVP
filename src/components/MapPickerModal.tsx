      ...
      >
        ...
        >
          <button
            type="button"
            onClick={onClose}
            className="px-3.5 py-2 text-xs font-bold text-rose-600 bg-rose-50 hover:bg-rose-100 border border-rose-200 rounded-xl transition-colors active:scale-95"
          >
            বাতিল
          </button>
          <button
