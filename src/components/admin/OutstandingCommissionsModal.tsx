      ...
      <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-5 border-t border-gray-100 bg-gray-50 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="py-2 px-5 rounded-xl bg-rose-50 hover:bg-rose-100 font-extrabold text-xs text-rose-600 border border-rose-200 active:scale-95 transition-colors"
          >
            Close
          </button>
        </div>
