...
export const DEFAULT_PRICING_SETTINGS: PricingSettings = {
  ...
  inAppBrowserPromptEnabled: true,
  inAppBrowserPromptTitle: 'ব্রাউজারে ওপেন করুন',
  inAppBrowserPromptSubtitle: 'Open in Chrome or Safari for the Best Experience',
  inAppBrowserPromptMessage: 'ফেসবুক বা মেসেঞ্জারের ভেতর গুগল অ্যাকাউন্ট লগইন সরাসরি ব্লক হতে পারে বা বারবার লগইন চাইতে পারে। Chrome বা Safari ব্রাউজারে খুললে ১-ক্লিকে লগইন, লাইভ ট্র্যাকিং এবং অফলাইন সুবিধা সচল থাকবে।',
